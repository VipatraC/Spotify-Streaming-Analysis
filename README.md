...
The goal of this project is to determine which characteristics contribute most to song popularity and translate these findings into actionable insights for the music industry.

📊 Executive Summary

The analysis reveals that songs with higher energy and danceability tend to achieve greater popularity. Certain tempo ranges and loudness levels are also associated with successful tracks. Additionally, pop and hip-hop genres dominate streaming platforms.
